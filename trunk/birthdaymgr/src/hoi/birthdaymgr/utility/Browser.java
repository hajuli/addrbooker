...
/**
 * Browser is a class that provides one static method, openURL, which opens the
 * default web browser for the current user of the system to the given URL. It
 * may support other protocols depending on the system -- mailto, ftp, etc. --
 * but that has not been rigorously tested and is not guaranteed to work.
 * <p>
 ...
 * 
 * @author <a href="mailto:jacob.dreyer@geosoft.no">Jacob Dreyer</a> Added
 *         methods to the API and adjusted the linux version slightly.
 */
    ...
    public static void openUrl(String url) throws IOException {
        ...
        case WINDOWS_9x:
            ...
            Process process = Runtime.getRuntime().exec(new String[] {
                    (String) browser, FIRST_WINDOWS_PARAMETER, SECOND_WINDOWS_PARAMETER, THIRD_WINDOWS_PARAMETER, '"' + url + '"' });
