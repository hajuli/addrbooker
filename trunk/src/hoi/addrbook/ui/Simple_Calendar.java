...
public class Simple_Calendar extends JFrame implements ActionListener {
	...
	class List_MouseListener implements MouseListener {//鼠标移入时显示的信息
		...
		public String constellation(Calendar cal) {
			...
			String[][] con = { { "水瓶座", "0122", "0221" }, { "双鱼座", "0222", "0321" }, { "白羊座", "0322", "0420" }, { "金牛座", "0421", "0521" },
					{ "双子座", "0522", "0621" }, { "巨蟹座", "0621", "0721" }, { "狮子座", "0722", "0821" }, { "处女座", "0822", "0921" }, { "天秤座", "0922", "1021" },
		...
		public void mouseEntered(MouseEvent e) {//鼠标进入到组件上时调用。
			...
			if (lab != "") {
				...
				message += lunar.get_month() + "月" + lunar.get_Big_Or_Small() + "&nbsp;& nbsp;&nbsp;&nbsp;" + lunar.get_date() + "日";
...
class Lunar {
	...
	private String[] LunarHolDayName = { "小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑", "立秋", "处暑", "白露", "秋分", "寒露",
			"霜降", "立冬", "小雪", "大雪", "冬至" };

	static SimpleDateFormat chineseDateFormat = new SimpleDateFormat(" yyyy年MM月dd日 ");
	final static long[] lunarInfo = new long[] { 0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2, 0x04ae0, 0x0a5b6,
			...
			0x1a5b4, 0x025d0, 0x092d0, 0x0d2b2, 0x0a950, 0x0b557, 0x06ca0, 0x0b550, 0x15355, 0x04da0, 0x0a5b0, 0x14573, 0x052b0, 0x0a9a8, 0x0e950, 0x06aa0,
			...
			0x0d558, 0x0b540, 0x0b6a0, 0x195a6, 0x095b0, 0x049b0, 0x0a974, 0x0a4b0, 0x0b27a, 0x06a50, 0x06d40, 0x0af46, 0x0ab60, 0x09570, 0x04af5, 0x04970,
