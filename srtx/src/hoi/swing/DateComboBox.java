...
public class DateComboBox extends JComboBox {
    ...
    private static final long serialVersionUID = 164275517448307532L;
    protected SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy年M月d号");
    ...
    class DatePopup implements ComboPopup, MouseMotionListener, MouseListener, KeyListener, PopupMenuListener {
        ...
        protected SimpleDateFormat monthFormat = new SimpleDateFormat("yyyy年M月");
        ...
        protected void initializePopup() {
            ...
            label = createUpdateButton(Calendar.MONTH, 1);
            label.setText(" > ");
            label.setToolTipText("下一月");
            header.add(label);

            label = createUpdateButton(Calendar.YEAR, 1);
            label.setText(" >> ");
            label.setToolTipText("下一年");
